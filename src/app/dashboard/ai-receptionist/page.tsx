...
export default function AIReceptionistPage() {
  const [config, setConfig] = useState({
    system_prompt: 'You are a professional AI receptionist for a business. Greet callers warmly, understand their needs, and route them to the right person or provide helpful information.',
    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Configure your AI-powered call answering system</p>
        </div>
        <div className="flex items-center gap-3">
          <div className={lex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium }>
